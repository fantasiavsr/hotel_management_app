                    ...
                    preFilter: {
                        ...
                        "PSEUDO": function(match) {
                            ...
                            if (match[3]) {
                                ...
                                (excess = unquoted.indexOf(")", unquoted.length - excess) - unquoted
                                    .length)) {
                            ...
                            return function(elem) {
                                ...
                                return operator === "=" ? result === check :
                                    ...
                                    operator === "~=" ? (" " + result.replace(rwhitespace, " ") +
                                        " ").indexOf(check) > -1 :
                                    operator === "|=" ? result === check || result.slice(0, check
                                        .length + 1) === check + "-" :
                                    false;
                        ...
                        pipe: function( /* fnDone, fnFail, fnProgress */ ) {
                            ...
                            return jQuery.Deferred(function(newDefer) {
                                jQuery.each(tuples, function(_i, tuple) {
                                    ...
                                    var fn = isFunction(fns[tuple[4]]) && fns[tuple[
                                        4]];
                                    ...
                                    deferred[tuple[1]](function() {
                                        var returned = fn && fn.apply(this,
                                            arguments);
                                        if (returned && isFunction(returned
                                                .promise)) {
                                            returned.promise()
