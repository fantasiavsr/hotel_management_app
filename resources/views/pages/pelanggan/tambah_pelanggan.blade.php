            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between pt-2 mt-4 mb-4">
                        <h1 class="h3 mb-0 font-weight-bold" style="color: black">Tambah Pelanggan</h1>
                    ...
                    <div class="mb-5">
                        <form action="{{ route('tambah_pelanggan_store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col form-outline mb-4">
                                            ...
                                            <input type="text" name="nohp" class="form-control" autofocus required style="background-color: #FAFAFA">
                                        </div>
                                        <div class="col form-outline mb-4">
                                            <label class="form-label">NIK</label>
                                            <input type="text" name="nik" class="form-control" autofocus required style="background-color: #FAFAFA">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col form-outline mb-4">
                                            ...
                                            <input type="text" name="address" class="form-control" autofocus required style="background-color: #FAFAFA">
                                        </div>
                                    </div>
