            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between pt-2 mt-4 mb-4">
                        <h1 class="h3 mb-0 font-weight-bold" style="color: black">Tambah Ruangan</h1>
                                ...
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col form-outline mb-4">
                                            ...
                                            <input type="number" name="bed" class="form-control" autofocus required style="background-color: #FAFAFA">
                                        </div>
                                        <div class="col form-outline mb-4">
                                            <label class="form-label">Jumlah Kamar Mandi</label>
                                            <input type="number" name="bathroom" class="form-control" autofocus required style="background-color: #FAFAFA">
                                        </div>
                                        <div class="col form-outline mb-4">
                                            <label class="form-label">Luas</label>
                                            <input type="text" name="size" class="form-control" autofocus required style="background-color: #FAFAFA">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="row">
                                        <div class="col form-outline mb-4">
                                            ...
                                            <input type="text" name="desc" class="form-control" autofocus style="background-color: #FAFAFA">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col form-outline mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col form-outline mb-4">
                                            ...
                                            <input type="text" name="propsDetails" class="form-control" autofocus style="background-color: #FAFAFA">
                                        </div>
                                    </div>
                                </div>
                            </div>
