            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between pt-2 mt-4 mb-4">
                        <h1 class="h6 mb-0 font-weight-bold" style="color: black">Aktivitas Check Out</h1>
                                                ...
                                                @if (isset($checkout))
                                                    @foreach ($checkout as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{ /* booking checkin */ $booking->where('id', $item->booking_id)->first()->checkout }}
                                                            </td>
                                                            <td>
                                                                @if (isset($item->time))
                                                                    <div class="col">
                                                            ...
                                                            <td>
                                                                @if (isset($item->time))
                                                                    <a href="{{ route('checkoutUndo', $item->id) }}"
                                                                        class="btn btn-warning btn-sm">Undo Check Out</a>
                                                                @else
                                                                    <a href="{{ route('checkoutUpdate', $item->id) }}"
