<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" style="background-color: #white; z-index:2">
    ...
    <li class="nav-item">
        <a class="nav-link" href=""
            @if ($title === 'Dashboard') style="color: #3974FE; background-color:#F9FAFC;  border-right: 8px solid #3974FE;" @endif>
